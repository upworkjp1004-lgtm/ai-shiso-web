...
const FALLBACK_BY_TYPE = {
  quiet_idealist: {
    definition:"あなたは、「世界がもう少し良くなれる」と信じている。声には出さないが、諦めていない。その静かな確信が、孤独の中でも消えないでいる。",
    contradiction:"理想を持ち続けるのは、傷つき続けることでもある。それを知りながら、まだ手放せていない。",
    solitude:"ひとりの時間に、誰かのことを考えている。孤独を選んでいるように見えて、本当はつながりを求めている。",
    distance:"社会の中にいながら、どこか一枚ガラスの向こう側にいる感じがする。理解されたいのに、理解されることを恐れている。",
    quote:"あなたは誰にも期待していないフリをしながら、本当はただ一人に分かってほしいだけだ。",
  },
  gentle_optimist: {
    definition:"あなたは、悲しいことを知っていながら、それでも小さな良さを探すことをやめない。それは諦めではなく、生き延びる方法だ。",
    contradiction:"楽観的に見せているのは、本当の絶望を誰にも見せたくないからかもしれない。",
    solitude:"「大丈夫」と言い続けることで、誰かに心配をかけないようにしている。でも、本当は大丈夫じゃない夜もある。",
    distance:"誰かのそばにいることで安心するが、その安心を求めている自分を、少し弱いと感じている。",
    quote:"あなたは、幸せになることを許可することが、まだできていないのかもしれない。",
  },
  calm_mediator: {
    definition:"あなたは、誰かが傷つくのを見ると自分が傷ついたように感じる。それがあなたの強さであり、疲れる理由でもある。",
    contradiction:"人のために動きながら、自分の感情を一番後回しにしている。それに気づいているが、変え方がわからない。",
    solitude:"ひとりになると、やっと本当の自分の感情を感じられる。人といる間は、どこかを閉じている。",
    distance:"誰にでも優しくできるのに、一番近い人に素直になれない。それがずっと続いている。",
    quote:"あなたは、自分の気持ちを後回しにすることに、もう慣れすぎている。",
  },
  soft_realist: {
    definition:"あなたは夢を持ちながら、失望することへの耐性も育ててきた。その両方を持っている人間は、見た目より複雑だ。",
    contradiction:"現実的でいようとするたびに、どこかで「本当はそう思っていない」という感覚が湧いてくる。",
    solitude:"一人でいると、理想と現実の間でまだ揺れている自分に気づく。誰かといるときは隠している。",
    distance:"感情を整理してから表に出す癖がある。でも整理する前に、もう感情は消えていることが多い。",
    quote:"あなたは、期待することに疲れたのではなく、裏切られることに疲れたのだ。",
  },
  tender_wanderer: {
    definition:"あなたは、どこにも完全には属せないまま、それをアイデンティティにしてきた。居場所のなさを、スタイルに変えた人だ。",
    contradiction:"自由でいたいはずなのに、誰かに引き止めてほしい夜がある。それを認めることが、なかなかできない。",
    solitude:"ひとりでいることに慣れた。でもそれは、孤独に強くなったのではなく、孤独に慣れただけかもしれない。",
    distance:"誰かが近づいてくると、少し引いてしまう。傷つく前に距離を取るのが、もう癖になっている。",
    quote:"あなたは、つながりを怖れているのではなく、またいつか離れることを、先に知っているのだ。",
  },
  night_observer: {
    definition:"あなたは感情を表に出すより、内側で処理することを選んできた。それが冷静さとして見えるが、本当は感情が豊かすぎるだけだ。",
    contradiction:"誰よりも多くのことを感じているのに、誰よりも感情的に見えないようにしている。その矛盾が、内側でずっと鳴っている。",
    solitude:"人といても、少し遠いところから観察している自分がいる。完全に溶け込めない感覚が、ずっとある。",
    distance:"本音を話したあとに後悔する経験を、何度かしてきた。だから今は、話す前に考えすぎる。",
    quote:"あなたが「大丈夫」と言うとき、本当に大丈夫なことはあまりない。",
  },
  deep_thinker: {
    definition:"あなたは考えることをやめられない。それは才能であると同時に、眠れない夜を作る理由でもある。",
    contradiction:"答えを求めているのではなく、問い続けることで何かを先送りにしているのかもしれない。",
    solitude:"ひとりの夜が一番頭が働く。でも、誰かに話を聞いてほしい夜も、同じくらいある。",
    distance:"人の言葉を受け取るより先に、分析してしまう。その癖が、素直に感動することを邪魔している。",
    quote:"あなたは、考えれば考えるほど、自分が正しい答えから遠ざかっていく気がしている。",
  },
  word_seeker: {
    definition:"あなたは、感じていることを正確に言葉にしたいが、言葉にした瞬間に少し嘘になる感覚を知っている。",
    contradiction:"言葉を探しているのに、見つかった言葉では足りない。そのジレンマが、ずっと続いている。",
    solitude:"誰かに話すより、一人で書いているときの方が正直になれる。声に出すと、どこかが変わる。",
    distance:"「わかった」と言われると、少しがっかりする。本当にわかってもらえているとは思えないから。",
    quote:"あなたは、理解されたいのではなく、理解しようとされることが怖いのかもしれない。",
  },
  lone_explorer: {
    definition:"あなたは答えを求めながら、答えが出ることを少し恐れている。問いが続く限り、前に進む理由があるから。",
    contradiction:"探求しているように見えて、本当は安心できる場所を探しているだけかもしれない。",
    solitude:"ひとりでいることは選んでいる。でもその選択の奥に、「選ばなければならなかった」事情があることを、自分では知っている。",
    distance:"人と深くつながる前に、先に答えを探してしまう。感情より論理を先に動かすのが、もう習慣になっている。",
    quote:"あなたは、終着点のない旅をしている。それが苦しいのか心地いいのか、まだ決めかねている。",
  },
  horizon_watcher: {
    definition:"あなたは、今ここにいながら、どこか遠くを見ている。その視線には、今まだ形になっていない何かが映っている。",
    contradiction:"理想を持ち続けることと、現実に傷つくことを、同時にやり続けている。どちらも手放せないでいる。",
    solitude:"遠くを見るために、近くから少し離れる必要がある。その距離が、孤独に見えることがある。",
    distance:"「今」に完全に満足できない。もう少し先に、本当のものがある気がして、ずっと歩いている。",
    quote:"あなたは、今いる場所が終着点だとは、どうしても思えないでいる。",
  },
  quiet_rebel: {
    definition:"あなたは声を上げないが、内側では常に何かに抵抗している。その静けさは、諦めではなく選択だ。",
    contradiction:"反抗したいわけじゃない。ただ、従えない理由が消えないだけだ。それを説明するのに疲れている。",
    solitude:"理解されることへの期待を、静かに手放してきた。それが強さになったか、諦めになったかは、まだわからない。",
    distance:"集団の中で浮いている感覚がある。それが悪いとは思っていないが、楽だとも思っていない。",
    quote:"あなたは、「違う」と言う代わりに、ただそこにいないことを選んできた。",
  },
  free_rebel: {
    definition:"あなたは型を壊したいのではなく、型に収まらない自分をそのまま認めてほしいだけかもしれない。",
    contradiction:"自由でいたいはずなのに、誰かに認められたいという感覚が、まだ消えていない。",
    solitude:"自由を選ぶことと、孤独を受け入れることは、セットになっている。それを知りながら、歩き続けている。",
    distance:"社会のルールに反発する前に、そのルールを誰より深く理解している。だから余計に、従えない。",
    quote:"あなたは自由を求めているが、本当に自由になれるのか、少し怖い気もしている。",
  },
  lone_sailor: {
    definition:"あなたは行き先より、今自分がどこを航っているかを大切にしている。到着より、航海そのものに意味がある人だ。",
    contradiction:"どこへ向かっているかわからないまま動き続けることを、選んでいるのか流されているのか、自分でも判断できていない。",
    solitude:"一人でいることが自然だと思っていたが、誰かが隣にいる瞬間に、それが特別だと気づく。",
    distance:"港に戻ることを、少し恐れている。戻ったとき、そこがまだ自分の場所であるかどうか、確かめるのが怖いから。",
    quote:"あなたは、目的地のない旅を続けている。それは迷子なのか、自由なのか、まだわからない。",
  },
  emotion_collector: {
    definition:"あなたは感情を捨てられない。悲しいことも、美しいと感じてしまう性質がある。それが豊かさでもあり、重さでもある。",
    contradiction:"感じることをやめれば楽になると知っている。でもそれは自分を失うことと同じで、やめられない。",
    solitude:"ひとりになると、ため込んでいた感情が一気に出てくる。人前ではずっと、どこかを閉じている。",
    distance:"人と感情を共有することが怖い。傷つけるかもしれないし、傷つくかもしれない。どちらも、もう知っている。",
    quote:"あなたは、感情を持ちすぎていることを、弱さだと思ってきた。でもそれは、ただ正直なだけだ。",
  },
  deep_romanticist: {
    definition:"あなたは感情の深さを理性より信頼している。それは正しいかどうかわからないが、あなたにはそれしかない。",
    contradiction:"深夜だけ、本当の感情が出てくる。昼間はそれを閉じ込めて動いている。その二重生活に、少し疲れている。",
    solitude:"夜が一番正直でいられる。それは孤独の時間ではなく、やっと自分に戻れる時間だ。",
    distance:"感情を丸ごとぶつけることを、学んでこなかった。だからいつも、少し手前で止めてしまう。",
    quote:"あなたは、深夜にだけ本音の自分がいて、朝になるとまたしまい込む。それをずっと繰り返している。",
  },
  boundary_walker: {
    definition:"あなたはどこにも完全には属せない。でもそれは欠陥ではなく、どこからでも見えるということかもしれない。",
    contradiction:"境界線の上にいることを選んでいるのか、追い出されているのか、自分でもまだわかっていない。",
    solitude:"どちら側にも入り切れないまま、どちら側の言葉もわかる。それは孤独だが、誰にもできないことでもある。",
    distance:"属している感覚がないまま、関係だけは続いている。それが居心地いいのか、慣れているだけなのか、区別できていない。",
    quote:"あなたは、どこにも完全にいないことで、どこにでもいられる。その静かな居場所を、まだ誰にも説明できていない。",
  },
  meaning_weaver: {
    definition:"あなたは意味を見出すことで、世界との距離を保っている。意味がないと思えた瞬間、足元が揺らぐのを知っている。",
    contradiction:"意味を作れると思っているが、その意味が壊れたとき、作り直す前にしばらく立てなくなる。",
    solitude:"ひとりの時間に、小さな意味を積み上げる。それが崩れないうちは、前に進める。",
    distance:"社会の意味体系に乗り切れない。でも自分だけの意味体系を持つことで、なんとか立っている。",
    quote:"あなたは、意味があると信じることで、やっと今日を生きることができている。",
  },
  gentle_nihilist: {
    definition:"あなたは何も意味がないと知りながら、それでも誰かに優しくできる。その矛盾した強さが、あなたを支えている。",
    contradiction:"虚無を知っているのに、まだ何かに傷ついている。本当に何も信じていないなら、傷つかないはずなのに。",
    solitude:"孤独に慣れた。でも慣れることと、望んでいることは違う。その区別が、夜になるとはっきりする。",
    distance:"人の輪には入れる。ただ、そこに完全に溶け込む意味が見つからないまま、端にいる。",
    quote:"あなたは「どうせ」と思いながら、まだどうにかしようとしている。その矛盾が、あなたの正直さだ。",
  },
  solitary_nihilist: {
    definition:"あなたは意味の不在を知っている。それでも毎朝目を覚ます。その行為自体が、どこかで意味を探している証明かもしれない。",
    contradiction:"何も信じていないと言いながら、まだ傷つくことがある。完全に無になれないから、完全には楽にもなれない。",
    solitude:"ひとりでいることに慣れた。でもそれは、孤独が心地いいのではなく、他の選択肢を閉じた結果かもしれない。",
    distance:"誰かに近づく前に、もう離れることを想定している。だから最初から、少し遠いところにいる。",
    quote:"あなたは、誰かに期待することをやめたのではなく、期待して裏切られることに、もう耐えられなくなっただけだ。",
  },
  logical_skeptic: {
    definition:"あなたは感情より論理を信頼してきた。でもそれは、感情を信頼するとどうなるかを、既に知っているからかもしれない。",
    contradiction:"冷静に見えるのは、感情を持っていないからではなく、感情を出すことが怖いからだ。その怖さは、まだ消えていない。",
    solitude:"一人でいる方が、論理が整理される。人といると、感情が入ってきて、計算が狂う。",
    distance:"人の言葉を信じる前に、まず疑う習慣がある。それは傷つかないための防衛で、もう体に染み込んでいる。",
    quote:"あなたは、感情を分析することで、感情から一歩引いて生きてきた。でもその分析は、時に感じることを邪魔する。",
  },
  border_dweller: {
    definition:"あなたはいくつかの方向へ同時に引っ張られている。それはどこにも属せない辛さでもあり、どこからでも見えるという強さでもある。",
    contradiction:"自分の価値観があるが、それが本当に自分のものかどうか、時々わからなくなる。",
    solitude:"ひとりのときと、誰かといるとき。どちらが本当の自分に近いか、まだ答えが出ていない。",
    distance:"社会とのつながりを断ちたいわけじゃない。ただ、完全に繋がることの怖さも知っている。",
    quote:"あなたは、どこにも完全にいないことを、弱さだと思ってきた。でも本当は、どこにでもいられるということだ。",
  },
  default: {
    definition:"あなたの思考は、一つの軸では捉えきれない。矛盾しているように見えるが、それがあなたの正直さの証明かもしれない。",
    contradiction:"自分の価値観を持ちながら、それが正しいかどうかを問い続けている。その問いは、終わらない。",
    solitude:"一人の時間と誰かといる時間、どちらが本当の自分に近いか、まだ答えが出ていない。",
    distance:"社会との距離を意識しながら、完全には切れないでいる。それがちょうど良い、という感覚もある。",
    quote:"あなたは、分類されることに少し安心しながら、分類されきることを少し嫌がっている。",
  },
};
...
━━ 最重要ルール ━━
このテキストを読んだユーザーが「なんで分かるの…？」と感じなければ失敗。
「これは私の説明書だ」と感じさせることが唯一の目標。

━━ 必須の要素 ━━
・矛盾を突く: 「〜したいのに、〜してしまう」という逆説
・弱さを言語化: 強がっているが本当は傷ついている部分
・本音を突く: 「誰にも期待していないフリをしているが、本当は」
・少し痛い: 耳に痛いが否定できない観察
・少し優しい: 責めず、ただ見ている感覚
・夜に刺さる: 深夜2時に読んで共感する文体

━━ 禁止 ━━
・「あなたは〜です」という断定的な人物評
・自己啓発・ポジティブな励まし・ChatGPT的相槌
・「素晴らしい」「魅力的な」「バランスよく」
・誰にでも当てはまる抽象的な内容
・診断サイトっぽいテンプレ文
...
━━ 文体の温度感 ━━
・カミュ・シオラン的な「冷静な観察」
・でも完全に冷たくない。どこかに「見ていた」という温度
・「あなたは〜なのかもしれない」「〜という感覚が、まだある」
・断定ではなく、観察。評価ではなく、解剖。

━━ 各フィールドの指針 ━━
definition（思想定義・50〜70字）: その人の思考の「核心的矛盾」を冷静に解剖。表面ではなく、行動パターンの奥にある構造を。
contradiction（内面的矛盾・40〜60字）: 「〜のに、〜してしまう」形で。誰にでも当てはまらない、この人固有の矛盾を。
solitude（孤独との関係・35〜55字）: 一人でいることと、孤独感の関係。「選んでいる」のか「なっている」のかの曖昧さを。
distance（社会との距離・35〜55字）: 人間関係における癖・防衛パターン。「距離を取る理由」を。
quote（刺さる一文・25〜40字）: SNSで保存されるような言葉。「これは私だ」と思わせる。自己啓発にならないこと。
...
この具体的な回答から、その人固有の内面的矛盾を読み取り、「なんで分かるの？」と思わせる5フィールドのJSONを生成してください。
抽象的な哲学解説ではなく、この人の「深夜の感情パターン」を言語化すること。`;
...
const GLOBAL_CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @keyframes rainFall {
    0%   { transform: translateY(-5vh) translateX(0) scaleY(0.8); opacity: 0; }
    8%   { opacity: 1; }
    92%  { opacity: 0.4; }
    100% { transform: translateY(108vh) translateX(-4vw) scaleY(1.1); opacity: 0; }
  }
  @keyframes rainFallB {
  ...
  @keyframes neonBreathB {
    0%,100%{ opacity:0.12; filter:blur(100px); }
    40%    { opacity:0.20; filter:blur(110px); }
  }
  /* ガラス水滴 — より細く遅く */
  @keyframes dropSlide {
    0%   { transform: translateY(0) scaleY(1); opacity: 0; }
    15%  { opacity: 0.35; }
    85%  { transform: translateY(160px) scaleY(1.8); opacity: 0.15; }
    100% { transform: translateY(175px) scaleY(0.6); opacity: 0; }
  }
  /* 深夜モード特殊グロー */
  ...
  /* 個別雨粒 — 極細・低コントラスト・背景に馴染む */
  .rain-drop {
    position: absolute; top: 0;
    width: 0.5px;
    background: linear-gradient(180deg,
      transparent 0%,
      rgba(160,195,240,0.18) 30%,
      rgba(140,180,230,0.22) 60%,
      transparent 100%
    );
    border-radius: 999px;
  }
  ...
  .neon-bg-purple {
    ...
    background: radial-gradient(circle,
      rgba(80,30,180,0.28) 0%,
      rgba(50,10,140,0.14) 40%,
      transparent 70%
    );
    animation: neonBreath 16s ease-in-out infinite;
  }
  .neon-bg-blue {
    position: fixed; pointer-events: none; z-index: 0; border-radius: 50%;
    background: radial-gradient(circle,
      rgba(20,60,180,0.22) 0%,
      rgba(8,30,120,0.10) 45%,
      transparent 70%
    );
    animation: neonBreathB 22s ease-in-out 4s infinite;
  }
  .neon-bg-cyan {
    position: fixed; pointer-events: none; z-index: 0; border-radius: 50%;
    background: radial-gradient(circle,
      rgba(0,120,180,0.14) 0%,
      rgba(0,60,120,0.06) 50%,
      transparent 70%
    );
    animation: neonBreath 28s ease-in-out 10s infinite;
  }
  /* ガラス水滴 */
  .glass-drop {
...
// 雨粒データ（数を減らし・細く・短く・背景に溶け込む設計）
const RAIN_DROPS = Array.from({ length: 28 }, (_, i) => ({
  id: i,
  left: `${Math.random() * 100}%`,
  height: `${18 + Math.random() * 32}px`,   // 40-120px → 18-50px に縮小
  duration: `${1.2 + Math.random() * 1.4}s`, // 速度を落として自然に
  delay: `${Math.random() * 5}s`,
  opacity: 0.06 + Math.random() * 0.14,      // 0.15-0.50 → 0.06-0.20 に低下
  type: i % 3,
}));

// ガラス水滴データ（数を減らし・より細く）
const GLASS_DROPS = Array.from({ length: 6 }, (_, i) => ({
  id: i,
  left: `${72 + Math.random() * 22}%`, // 右端寄りに集約
      ...
      <div ref={containerRef}
        ...
        {phase === "result" && result && (
          <div className="phase-result" style={{ paddingTop:52 }}>
            ...
            {/* ── NOCTURNE INDEX（孤独指数・感情ノイズ・現実逃避度） */}
            {result && (() => {
              // traits から3つの指数を計算
              const lonelyIndex   = Math.round((result.traits.loneliness * 0.55 + result.traits.nihilism * 0.3 + (100 - result.traits.community) * 0.15));
              const emotionNoise  = Math.round((result.traits.emotion * 0.45 + result.traits.sensitivity * 0.3 + result.traits.romanticism * 0.25));
              const escapeTendency = Math.round((result.traits.nihilism * 0.35 + result.traits.loneliness * 0.25 + result.traits.idealism * 0.25 + (100 - result.traits.stability) * 0.15));

              const indices = [
                { label:"孤独指数",   value: lonelyIndex,    desc: lonelyIndex >= 70 ? "独りの時間が核心にある" : lonelyIndex >= 50 ? "孤独と共存している" : "つながりを大切にする",   color:"#8890a8" },
                { label:"感情ノイズ", value: emotionNoise,   desc: emotionNoise >= 70 ? "感情が常に鳴っている" : emotionNoise >= 50 ? "感情の振れ幅がある" : "感情を整理して動く",    color:"#c87ac8" },
                { label:"現実逃避度", value: escapeTendency, desc: escapeTendency >= 70 ? "今ここにいることが難しい" : escapeTendency >= 50 ? "どこか遠くを向いている" : "今に根ざしている", color:"#7aaedd" },
              ];

              return (
                <div className="result-card-stagger" style={{ marginBottom:16 }}>
                  <div className="glass-card" style={{
                    background:"rgba(15,20,40,0.1)", border:"1px solid rgba(60,80,140,0.18)",
                    marginBottom:0,
                  }}>
                    <div className="archive-bar">
                      <div className="archive-dot" />
                      <span className="archive-tag">NOCTURNE INDEX</span>
                      <span className="archive-id">INTERNAL STATE</span>
                    </div>
                    ...
                    <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
                      {indices.map(({ label, value, desc, color }) => (
                        <div key={label}>
                          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"baseline", marginBottom:5 }}>
                            <span style={{ fontFamily:"var(--f-jp)", fontSize:12, color:"rgba(185,200,228,0.85)", fontWeight:300 }}>
                              {label}
                            </span>
                            <span style={{ fontFamily:"var(--f-serif)", fontStyle:"italic", fontSize:20,
                              color, fontWeight:300, letterSpacing:"0.02em" }}>
                              {value}
                            </span>
                          </div>
                          <div style={{ height:2, background:"rgba(255,255,255,0.04)", borderRadius:999, overflow:"hidden", marginBottom:5 }}>
                            <div style={{
                          ...
                          <div style={{ fontFamily:"var(--f-jp)", fontSize:10, color:"rgba(100,120,170,0.55)",
