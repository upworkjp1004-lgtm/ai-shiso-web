...
const Q_TREE = {
  ...
  "q_rationalize": {
    ...
    options:[
      ...
      {
        label:"意味がなくても、行為そのものに価値がある",
        scores:{ community:+2, stability:+2, optimism:+1 },
        nextId:"q_connection",
      },
      {
        label:"意味という概念自体が幻想かもしれない",
  ...
  "q_mood_structure_deep": {
    ...
    options:[
      ...
      {
        label:"いいえ。個人の自由が最大限尊重されるべきだ",
        scores:{ stability:+3, logic:+1, nihilism:+1 },
        nextId:"q_final",
      },
      {
        label:"その問い自体が間違っている。両者は対立しない",
...
const QUICK_QUESTIONS = [
  {
    ...
    options:[
      { label:"はい。人間は状況に関わらず自由を持つ",       scores:{ loneliness:+3, freedom:+2, community:-2, nihilism:+1 } },
      { label:"自由は存在するが、失うことへの恐れを伴う",       scores:{ nihilism:+3, sensitivity:+2, loneliness:+2, idealism:-1 } },
      { label:"はい。自由は社会の中で他者と共に実現される",                  scores:{ community:+3, stability:+2, emotion:+2, optimism:+1 } },
      { label:"自由は幻想だ。構造と条件に縛られている",       scores:{ sensitivity:+4, stability:-2, idealism:+1, community:+1 } },
    ]
  },
  {
    id:"q2",
    text:"善悪には普遍的な基準があると思いますか？",
    options:[
      { label:"ある。理性が普遍的基準を導き出せる",                scores:{ sensitivity:+4, stability:-3, nihilism:+1 } },
      { label:"ある。ただし文化・時代によって異なる",                  scores:{ sensitivity:+2, stability:+1, realism:+1 } },
      { label:"ない。善悪は権力関係によって作られる",              scores:{ stability:+3, logic:+2, freedom:+1 } },
      { label:"ない。しかしそれでも道徳は必要だ",                scores:{ loneliness:+2, freedom:+2, community:-2 } },
    ]
  },
  {
    id:"q3",
    text:"人生に「意味」は必要だと思いますか？",
    options:[
      { label:"必要だ。意味なしには生きられない",            scores:{ sensitivity:+3, stability:-2, loneliness:+1 } },
      { label:"意味は必要だが、自分で作るものだ",      scores:{ logic:+2, sensitivity:+2, community:+0 } },
  ...
  {
    id:"q4",
    text:"社会秩序は個人の自由より優先されるべきですか？",
    options:[
      { label:"はい。社会なくして個人の自由もない",            scores:{ logic:+3, sensitivity:+2, rationality:+1 } },
      { label:"場合による。状況と文脈が重要だ",   scores:{ sensitivity:+2, nihilism:+2, stability:-1 } },
  ...
  {
    id:"q5",
    text:"不条理な世界でも、生きることに価値はあると思いますか？",
    options:[
      { label:"落ち着く。これくらいが一番自分らしい",          scores:{ loneliness:+3, freedom:+3, community:-1 } },
      { label:"ある。自ら意味を作ることが人間の仕事だ",      scores:{ loneliness:+2, nihilism:+2, community:-1 } },
      { label:"悪くないけど、誰かと来たかったとも思う",         scores:{ romanticism:+3, loneliness:+1, community:+1, emotion:+2 } },
      { label:"分からない。その問いを問い続けることが全てだ",            scores:{ nihilism:+3, stability:+2, emotion:-2 } },
    ]
  },
];
...
const THOUGHT_TYPES = [
  ...
  // ── 明るめ / 穏やか系（偏りを補正）
  {
    id:"quiet_idealist", name:"理想主義",
    color:"#7ab8d8", sub:"あなたは理想主義的な傾向があります",
    glow:["rgba(30,80,150,0.55)","rgba(20,70,130,0.4)","rgba(15,60,120,0.25)"],
    xText:"あなたは理想主義です。世界はもう少しよくなれると静かに信じ、日々の選択の中に理想を宿している。#ソクラテス診断",
    cond:(t) => t.idealism>=62 && t.emotion>=55 && t.community>=52,
  },
  {
    id:"gentle_optimist", name:"批判的楽観主義",
    color:"#78c890", sub:"あなたは批判的楽観主義に近い思想を持っています",
    glow:["rgba(20,100,60,0.5)","rgba(15,90,50,0.35)","rgba(10,80,40,0.22)"],
    xText:"あなたは批判的楽観主義です。絶望を知りながらも、世界の小さな良さを拾い続けることを選んでいる。#ソクラテス診断",
    cond:(t) => t.idealism>=58 && t.realism>=55 && t.nihilism<=48,
  },
  {
    id:"calm_mediator", name:"功利主義",
    color:"#82c4a0", sub:"あなたは功利主義的な傾向があります",
    glow:["rgba(20,95,65,0.5)","rgba(15,85,55,0.38)","rgba(12,75,48,0.24)"],
    xText:"あなたは功利主義です。正しさよりも、最大多数の幸福とつながりを重視する傾向がある。#ソクラテス診断",
    cond:(t) => t.community>=63 && t.emotion>=58 && t.nihilism<=50,
  },
  {
    id:"soft_realist", name:"プラグマティズム",
    color:"#c8a870", sub:"あなたはプラグマティズム（実用主義）に近い思想を持っています",
    glow:["rgba(110,75,20,0.5)","rgba(100,65,15,0.38)","rgba(90,60,18,0.24)"],
    xText:"あなたはプラグマティズムです。理想を持ちながら、現実の中で機能する答えを探す実用的な思想。#ソクラテス診断",
    cond:(t) => t.realism>=62 && t.stability>=55 && t.community>=50,
  },
  {
    id:"tender_wanderer", name:"懐疑主義",
    color:"#b8a8d8", sub:"あなたは懐疑主義的な傾向があります",
    glow:["rgba(80,60,150,0.5)","rgba(70,50,135,0.38)","rgba(60,42,120,0.24)"],
    xText:"あなたは懐疑主義です。決めないことが誠実さの一形態だと知っている。余白の中に思想が宿る。#ソクラテス診断",
    cond:(t) => t.romanticism>=60 && t.emotion>=58 && t.freedom>=52 && t.nihilism<=52,
  },

  // ── 思索・観察系
  {
    id:"night_observer", name:"批判理論",
    color:"#8a9ab8", sub:"あなたは批判理論（フランクフルト学派）的な傾向があります",
    glow:["rgba(40,55,110,0.6)","rgba(55,40,100,0.45)","rgba(30,48,90,0.28)"],
    xText:"あなたは批判理論に近い思想を持っています。社会を観察し、距離を置くことで構造を見抜こうとする。#ソクラテス診断",
    cond:(t) => t.logic>=63 && t.loneliness>=58 && t.emotion<=50,
  },
  {
    id:"deep_thinker", name:"観念論",
    color:"#9888c8", sub:"あなたは観念論的な思想傾向があります",
    glow:["rgba(70,45,145,0.6)","rgba(60,35,130,0.45)","rgba(50,28,115,0.28)"],
    xText:"あなたは観念論です。答えの出ない問いほど手放せない。思考そのものが現実を構成すると感じている。#ソクラテス診断",
    cond:(t) => t.logic>=60 && t.idealism>=58 && t.stability<=50,
  },
  {
    id:"word_seeker", name:"言語哲学",
    color:"#a8b8d0", sub:"あなたは言語哲学的な傾向があります",
    glow:["rgba(50,75,130,0.55)","rgba(40,65,115,0.4)","rgba(32,55,100,0.26)"],
    xText:"あなたは言語哲学に近い思想を持っています。言葉にならないものを言葉にしようとすること、それ自体が哲学だ。#ソクラテス診断",
    cond:(t) => t.emotion>=60 && t.logic>=58 && t.loneliness>=52,
  },
  {
    id:"lone_explorer", name:"実存主義",
    color:"#7898c8", sub:"あなたは実存主義です",
    glow:["rgba(25,65,140,0.6)","rgba(20,55,125,0.45)","rgba(15,48,110,0.28)"],
    xText:"あなたは実存主義です。答えより問い続けることに意味を見出す。意味は与えられるものではなく、自ら作るものだ。#ソクラテス診断",
    cond:(t) => t.idealism>=60 && t.loneliness>=60 && t.freedom>=55,
  },
  {
    id:"horizon_watcher", name:"ロマン主義",
    color:"#88aac8", sub:"あなたはロマン主義的な思想傾向があります",
    glow:["rgba(30,70,130,0.55)","rgba(22,60,115,0.4)","rgba(15,52,100,0.26)"],
    xText:"あなたはロマン主義です。今ここにいながら、常に遠くを見ている。理性では割り切れない何かを大切にしている。#ソクラテス診断",
    cond:(t) => t.romanticism>=62 && t.idealism>=58 && t.community<=50,
  },

  // ── 自由・独立系
  {
    id:"quiet_rebel", name:"自由主義（リベラリズム）",
    color:"#c87888", sub:"あなたは自由主義（リベラリズム）的な傾向があります",
    glow:["rgba(130,35,55,0.58)","rgba(115,28,45,0.43)","rgba(100,22,38,0.27)"],
    xText:"あなたは自由主義です。声を上げずとも、従わない選択で自己を表現する。静かな抵抗が思想の形。#ソクラテス診断",
    cond:(t) => t.freedom>=65 && t.idealism>=60 && t.community<=48,
  },
  {
    id:"free_rebel", name:"無政府主義（アナーキズム）",
    color:"#d87858", sub:"あなたは無政府主義（アナーキズム）的な傾向があります",
    glow:["rgba(140,55,20,0.58)","rgba(125,45,15,0.43)","rgba(110,38,12,0.27)"],
    xText:"あなたはアナーキズムに近い思想を持っています。型にはまることへの根本的な抵抗。支配そのものを疑う。#ソクラテス診断",
    cond:(t) => t.freedom>=68 && t.stability<=45 && t.nihilism<=55,
  },
  {
    id:"lone_sailor", name:"実存主義（キェルケゴール的）",
    color:"#5898c8", sub:"あなたはキェルケゴール的な実存主義です",
    glow:["rgba(18,68,145,0.58)","rgba(12,58,128,0.43)","rgba(8,48,112,0.27)"],
    xText:"あなたはキェルケゴール的な実存主義です。目的地より航路を重んじ、孤独の中で自己と向き合う。#ソクラテス診断",
    cond:(t) => t.freedom>=62 && t.loneliness>=62 && t.community<=48,
  },

  // ── 感情・関係系
  {
    id:"emotion_collector", name:"現象学",
    color:"#d888a8", sub:"あなたは現象学的な思想傾向があります",
    glow:["rgba(150,40,80,0.55)","rgba(132,32,68,0.4)","rgba(115,25,58,0.26)"],
    xText:"あなたは現象学に近い思想を持っています。感情や経験そのものを丁寧に観察し、意味を見出そうとする。#ソクラテス診断",
    cond:(t) => t.emotion>=65 && t.romanticism>=58 && t.nihilism<=50,
  },
  {
    id:"deep_romanticist", name:"ロマン主義（感情優位）",
    color:"#c878d8", sub:"あなたはロマン主義（感情を理性より優先する立場）です",
    glow:["rgba(110,35,145,0.6)","rgba(95,28,128,0.45)","rgba(80,22,112,0.28)"],
    xText:"あなたはロマン主義です。感情の深さを理性より信頼する。深夜だけが正直になれる時間があると知っている。#ソクラテス診断",
    cond:(t) => t.romanticism>=65 && t.emotion>=62 && t.loneliness>=55,
  },
  {
    id:"boundary_walker", name:"弁証法的思考",
    color:"#98a8b8", sub:"あなたは弁証法的な思考傾向があります",
    glow:["rgba(50,65,115,0.5)","rgba(42,55,100,0.38)","rgba(34,46,88,0.24)"],
    xText:"あなたは弁証法的思考を持っています。どちらでもなく、どちらでもある。対立の中に真理を見る。#ソクラテス診断",
    cond:(t) => Math.abs(t.freedom - t.stability) <= 12 && Math.abs(t.community - t.loneliness) <= 15,
  },
  {
    id:"meaning_weaver", name:"実存主義（カミュ的）",
    color:"#a8c0a8", sub:"あなたはカミュ的な実存主義です",
    glow:["rgba(40,90,55,0.5)","rgba(32,80,46,0.38)","rgba(25,70,38,0.24)"],
    xText:"あなたはカミュ的な実存主義です。意味は与えられるものではなく、不条理の中で自ら作り続けるものだ。#ソクラテス診断",
    cond:(t) => t.idealism>=58 && t.realism>=55 && t.emotion>=55 && t.community>=50,
  },

  // ── ニヒル系
  {
    id:"gentle_nihilist", name:"ニヒリズム（温和型）",
    color:"#c89858", sub:"あなたはニヒリズムに近い思想を持っています",
    glow:["rgba(100,60,20,0.6)","rgba(90,50,15,0.45)","rgba(80,55,20,0.3)"],
    xText:"あなたはニヒリズムです。虚無を知りながら、それでも他者に優しくある。その矛盾がひとつの誠実さだ。#ソクラテス診断",
    cond:(t) => t.nihilism>=60 && t.emotion>=55,
  },
  {
    id:"solitary_nihilist", name:"ニヒリズム",
    color:"#7a8bb8", sub:"あなたはニヒリズムです",
    glow:["rgba(40,45,120,0.7)","rgba(60,30,110,0.5)","rgba(20,50,100,0.35)"],
    xText:"あなたはニヒリズムです。意味の不在を直視しながら、それでも問い続ける。その姿勢そのものが哲学だ。#ソクラテス診断",
    cond:(t) => t.nihilism>=65 && t.loneliness>=62,
  },
  {
    id:"logical_skeptic", name:"懐疑主義（論理的）",
    color:"#4a9aab", sub:"あなたは懐疑主義です",
    glow:["rgba(15,75,100,0.6)","rgba(10,65,90,0.45)","rgba(8,55,80,0.3)"],
    xText:"あなたは懐疑主義です。疑うことで最も誠実でいられると知っている。ウィトゲンシュタイン的な問いの哲学。#ソクラテス診断",
    cond:(t) => t.logic>=65 && t.nihilism>=55 && t.romanticism<=50,
  },

  // ── デフォルト
  {
    id:"border_dweller", name:"折衷主義",
    color:"#8898b8", sub:"あなたは折衷主義（複数の思想を横断する立場）的な傾向があります",
    glow:["rgba(40,55,110,0.55)","rgba(55,35,100,0.4)","rgba(30,50,90,0.28)"],
    xText:"あなたは折衷主義です。どの系譜にも収まりきらない。それは複雑さではなく、思想的な誠実さかもしれない。#ソクラテス診断",
    cond:(_) => true,
  },
];
...
const GLOBAL_CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  :root {
    ...
    --c-border2:rgba(255,255,255,0.055);
    --c-text:   rgba(228,232,248,0.97);
    --c-muted:  rgba(175,190,225,0.88);
    --c-dim:    rgba(140,160,200,0.70);
              ...
              {showQuestion && (
                <div style={{ marginTop: answers.length > 0 ? 18 : 0 }}>
                  ...
                  <div className="question-text" key={qKey} style={{
                    ...
                    <p style={{
                      fontFamily:"var(--f-serif)", fontStyle:"italic", fontWeight:300,
                      fontSize:"clamp(18px,4.2vw,24px)", lineHeight:1.75,
                      color:"rgba(232,238,252,0.98)", letterSpacing:"0.02em",
                    }}>
                      {currentQ.text}
                    </p>
                  </div>
